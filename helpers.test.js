...
describe('Helpers', () => {
  ...
  describe('countTokens', () => {
    it('should return correct token count', () => {
      ...
      expect(result).toBe(13); // 12 characters + 1 for the space
    });
  });
  ...
  describe('isBreakingMessageChain', () => {
    ...
    it('should return false if the last message role is user or system', () => {
      ...
      const resultUser = isBreakingMessageChain(capabilityMatch, lastMessageUser);
      const resultSystem = isBreakingMessageChain(capabilityMatch, lastMessageSystem);
